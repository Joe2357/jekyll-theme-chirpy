...
tags: [IMES, paper]
use_math: true
modify_date: 2021-02-15 04:10 +0900
---
...
- **PAD 계산**
  ...
  OWD_{hs}+\frac{B_s+B_p}{Th_p},&\text{if }i>1,\frac{B_p}{B_s}+1>\frac{Th_p}{Th_{hs}}\\
...
- 가능한 방법 : minRTT -> minPAD로 수정하는 것
  ...
  - subflow가 idle하다 = PS-Path나 HS-Path가 비어있는 CWND 공간이 있다
  - 성능 : minRTT보다 뛰어남
